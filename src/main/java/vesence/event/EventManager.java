...
public class EventManager {
   private static final Map<Class<? extends Event>, List<EventManager.MethodData>> REGISTRY_MAP = new ConcurrentHashMap<>();
   ...
   private static void invoke(EventManager.MethodData data, Event argument) {
      try {
         ...
         System.err.println("[EventManager] Unexpected error in " + data.getTarget().getName() + ": " + t.getMessage());
         t.printStackTrace();
      }
   }
