...
public class BlendModePipeline {
    ...
    private void ensureInitialized() {
        ...
        try {
            shader = ShaderProgram.fromResources("assets/vesence/shaders/core/blendmode.vsh", "assets/vesence/shaders/core/blendmode.fsh");

            int blockIndex = GL31.glGetUniformBlockIndex(shader.id(), "BlendData");
            ...
            System.err.println("BlendModePipeline initialization failed: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void drawBlend(float x, float y, float width, float height, float[] radii, int color,
                          float squirt, int blendMode, float[] matrix, float viewW, float viewH) {
        ...
        try {
            ...
            try {
                ...
                dataBuffer.putFloat(x); dataBuffer.putFloat(y); dataBuffer.putFloat(width); dataBuffer.putFloat(height);
                ...
                dataBuffer.putFloat(blendMode); dataBuffer.putFloat(squirt); dataBuffer.putFloat(0f); dataBuffer.putFloat(0f);
            ...
            System.err.println("BlendModePipeline draw failed: " + e.getMessage());
        }
    }
