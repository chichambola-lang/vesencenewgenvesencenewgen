...
public class MaskDiffPipeline {
    private static final Identifier PIPELINE_ID = Identifier.of("vesence", "pipeline/mask_diff");
    private static final Identifier VERTEX_SHADER = Identifier.of("vesence", "core/mask_diff");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("vesence", "core/mask_diff");
    ...
    private void ensureInitialized() {
        ...
        this.dummyVertexBuffer = RenderSystem.getDevice().createBuffer(
            () -> "vesence:mask_diff_dummy_vertex",
    ...
    public void createMask(
        ...
        GpuTextureView beforeView,
        GpuTextureView afterView,
        GpuTextureView depthBeforeView,
        GpuTextureView depthAfterView,
        int width,
        int height
    ) {
        ensureInitialized();
        ...
        try (RenderPass renderPass = encoder.createRenderPass(() -> "vesence:mask_diff_pass", targetView, OptionalInt.of(0x00000000))) {
