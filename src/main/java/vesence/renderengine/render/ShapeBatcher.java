...
final class ShapeBatcher {
   ...
   void enqueueGradientOutline(
      ...
      this.backend.enqueueGradientOutline(x, y, w, h, roundTopLeft, roundTopRight, roundBottomRight, roundBottomLeft, c00, c10, c11, c01, thickness, transform);
   }
   ...
   void enqueueCircleOutline(float cx, float cy, float radius, float startDeg, float pct, int color, float thickness, float[] transform) {
