...
public final class GlState {
   private static final int TEXTURE_UNIT_COUNT = 8;
   private GlState() {
   }
   ...
   public static GlState.Snapshot push() {
      ...
      try {
         ...
         for (int unit = 0; unit < TEXTURE_UNIT_COUNT; unit++) {
            ...
            s.texture2DPerUnit[unit] = GL11.glGetInteger(32873);
         }
         s.texture2D = s.texture2DPerUnit[s.activeTexture - 33984];
   ...
   public static void pop(GlState.Snapshot s) {
      if (s != null) {
         ...
         for (int unit = 0; unit < TEXTURE_UNIT_COUNT; unit++) {
            GL13.glActiveTexture(33984 + unit);
            GL11.glBindTexture(3553, s.texture2DPerUnit[unit]);
         }
   ...
   public static final class Snapshot {
      ...
      public final int[] texture2DPerUnit = new int[TEXTURE_UNIT_COUNT];
