package vesence.utils.render.world;
...
public final class WorldRenderLayers {
      ...
      private static final RenderPipeline POSITION_COLOR_QUADS_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_COLOR_SNIPPET })
                              .withLocation(Identifier.of("vesence", "pipeline/world/position_color_quads"))
      ...
      private static final RenderPipeline POSITION_COLOR_QUADS_NO_DEPTH_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_COLOR_SNIPPET })
                              .withLocation(Identifier.of("vesence", "pipeline/world/position_color_quads_no_depth"))
                              .withVertexFormat(VertexFormats.POSITION_COLOR, DrawMode.QUADS)
                              .withCull(false)
      ...
      private static final RenderPipeline POSITION_COLOR_QUADS_NO_DEPTH_BLEND_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_COLOR_SNIPPET })
                              .withLocation(
                                          Identifier.of("vesence", "pipeline/world/position_color_quads_no_depth_blend"))
                              .withVertexFormat(VertexFormats.POSITION_COLOR, DrawMode.QUADS)
                              .withCull(false)
                              .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                              .withDepthWrite(false)
      ...
      private static final RenderPipeline LINES_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.RENDERTYPE_LINES_SNIPPET })
                              .withLocation(Identifier.of("vesence", "pipeline/world/lines"))
      ...
      private static final RenderPipeline LINES_NO_DEPTH_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.RENDERTYPE_LINES_SNIPPET })
                              .withLocation(Identifier.of("vesence", "pipeline/world/lines_no_depth"))
                              .withVertexFormat(VertexFormats.POSITION_COLOR_NORMAL, DrawMode.LINES)
                              .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                              .withDepthWrite(false)
                              .build());
      ...
      private static final RenderPipeline TEXTURED_QUADS_NO_DEPTH_ADDITIVE_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_TEX_COLOR_SNIPPET })
                              .withLocation(Identifier.of("vesence", "pipeline/world/textured_quads_no_depth_additive"))
                              .withVertexFormat(VertexFormats.POSITION_TEXTURE_COLOR, DrawMode.QUADS)
                              .withCull(false)
                              .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                              .withDepthWrite(false)
      ...
      private static final RenderPipeline TEXTURED_QUADS_NO_DEPTH_PIPELINE = RenderPipelines.register(
                  RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_TEX_COLOR_SNIPPET })
                              .withLocation(Identifier.of("vesence", "pipeline/world/textured_quads_no_depth"))
                              .withVertexFormat(VertexFormats.POSITION_TEXTURE_COLOR, DrawMode.QUADS)
                              .withCull(false)
                              .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                              .withDepthWrite(false)
                              .withBlend(BlendFunction.TRANSLUCENT)
                              .build());
      private static final RenderLayer POSITION_COLOR_QUADS_LAYER = RenderLayer.of("vesence/world/position_color_quads", RenderSetup.builder(POSITION_COLOR_QUADS_PIPELINE).expectedBufferSize(1024).translucent().build());
      private static final RenderLayer POSITION_COLOR_QUADS_NO_DEPTH_LAYER = RenderLayer.of("vesence/world/position_color_quads_no_depth", RenderSetup.builder(POSITION_COLOR_QUADS_NO_DEPTH_PIPELINE).expectedBufferSize(1024).translucent().build());
      private static final RenderLayer POSITION_COLOR_QUADS_NO_DEPTH_BLEND_LAYER = RenderLayer.of("vesence/world/position_color_quads_no_depth_blend", RenderSetup.builder(POSITION_COLOR_QUADS_NO_DEPTH_BLEND_PIPELINE).expectedBufferSize(1024).translucent().build());
      private static final RenderLayer TEXTURED_QUADS_LAYER = RenderLayer.of("vesence/world/textured_quads", RenderSetup.builder(TEXTURED_QUADS_PIPELINE).expectedBufferSize(1024).translucent().build());
      private static final RenderLayer TEXTURED_QUADS_ADDITIVE_LAYER = RenderLayer.of("vesence/world/textured_quads_additive", RenderSetup.builder(TEXTURED_QUADS_ADDITIVE_PIPELINE).expectedBufferSize(1024).translucent().build());
      private static final RenderLayer TEXTURED_QUADS_NO_DEPTH_ADDITIVE_LAYER = RenderLayer.of("vesence/world/textured_quads_no_depth_additive", RenderSetup.builder(TEXTURED_QUADS_NO_DEPTH_ADDITIVE_PIPELINE).expectedBufferSize(1024).translucent().build());
      private static final RenderLayer TEXTURED_QUADS_NO_DEPTH_LAYER = RenderLayer.of("vesence/world/textured_quads_no_depth", RenderSetup.builder(TEXTURED_QUADS_NO_DEPTH_PIPELINE).expectedBufferSize(1024).translucent().build());
      ...
      public static RenderLayer LINES(double width) {
            ...
            return LINES_CACHE.computeIfAbsent(normalizedWidth,
                        value -> createLineLayer(value, "vesence/world/lines", LINES_PIPELINE));
      }

      public static RenderLayer LINES_NO_DEPTH(double width) {
            double normalizedWidth = normalizeWidth(width);
            return LINES_NO_DEPTH_CACHE.computeIfAbsent(normalizedWidth,
                        value -> createLineLayer(value, "vesence/world/lines_no_depth", LINES_NO_DEPTH_PIPELINE));
      }
